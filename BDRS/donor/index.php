...
<div class="header">
		<div class="logo">
			<h1><a href="index.php"><img src="images/logo.png" height="100px" width="400px" alt=""></a></h1>
		</div>
	</div>
</div>
</div>
...
<!-----------------Footer area end-------------------------->
   ...
   <!-- ##### All Javascript Script ##### -->
    ...
    <!-- Popper js -->
    <script src="js2/bootstrap/popper.min.js"></script>
    <!-- Bootstrap js -->
    <script src="js2/bootstrap/bootstrap.min.js"></script>
    <!-- All Plugins js -->
    <script src="js2/plugins/plugins.js"></script>
    <!-- Active js -->
